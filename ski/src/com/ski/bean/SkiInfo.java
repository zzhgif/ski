...
public class SkiInfo {
	...
	private String ski_price;//商品价格
	private String ski_size;//商品大小
	private String ski_color;//商品颜色
	private String ski_des;//商品描述
	private int ski_state;//商品状态
	private String ski_picture;//商品图片
	public SkiInfo(){}
	public SkiInfo(String ski_id, String ski_name, String ski_type, String ski_price, String ski_size, String ski_color,
			String ski_des, int ski_state, String ski_picture) {
		this.ski_id = ski_id;
	...
	public String getSki_price() {
		return ski_price;
	}
	public void setSki_price(String ski_price) {
		this.ski_price = ski_price;
	}
	...
	public int getSki_state() {
		return ski_state;
	}
	public void setSki_state(int ski_state) {
		this.ski_state = ski_state;
	}
